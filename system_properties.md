...
| `tungsten.types.numerics.ContinuedFraction.emitNullOnZeroTerm`                    | Boolean | false         | When iterating over a continued fraction, emit nulls if a zero term is encountered.                                                                         |
